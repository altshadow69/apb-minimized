...
This config is designed to upgrade and modernize the overall look of APB’s UI, making it cleaner and more up-to-date.  
as well as the implementation of the in-game icons image which i made a guide for. and the transparent UI element.  
> do note, that all textual changes are customized to match my personal style.  

Since the game still runs on Unreal Engine 3 for two decades now :goberserk: let pray for a more modder friendly engine in the near future :)  
...
> [!NOTE]
> minimized text markers will effects the map tooltip and it only shows the icons and break lines  
> you can selectively install in Options folder `[1] HUD Objective Markers` if you like.
- ### Transparent UI
...
![Preview](https://i.imgur.com/ROIxfFI.png)
- ### Minimized Reload Text With in Icon
![Preview](https://i.imgur.com/jdKFHrO.png)
