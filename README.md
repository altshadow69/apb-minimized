...
## About
 ...
 This configuration is designed to enhance and modernize the overall appearance of the APB's UI designed, making it less cluttered and up to date look.  

 It introduces in-game icon images, transparent UI elements and various visual refinements to give the interface a more contemporary look.
...
![Preview](https://i.imgur.com/9klOJaB.jpeg)
- ### Minimized Task Objective HUD Markers
![Preview](https://i.imgur.com/37Wt89w.png)
> [!NOTE]
...
![Preview](https://i.imgur.com/ul5WghW.png)
...
- ### New Main Menu 
![Preview](https://i.imgur.com/a4cSMT4.png)
- ### Transparent UI
![Preview](https://i.imgur.com/TSKGCxT.png)
...
```
 ...
 +	Leefekyn		— Mission Titles ( originally made titles config, and now its been modified by AltShadow )
